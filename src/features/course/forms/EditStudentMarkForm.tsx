...
export const EditStudentMarkForm = ({
  studentId,
  markType,
}: EditStudentMarkFormProps) => {
                  ...
                  <FormControl>
                    ...
                    >
                      <FormItem className='flex items-center space-x-3 space-y-0'>
                        ...
                        <FormLabel className='font-normal'>Пройдено</FormLabel>
                      </FormItem>
                      <FormItem className='flex items-center space-x-3 space-y-0'>
                        <FormControl>
                          <RadioGroupItem value='Failed' />
                        </FormControl>
                        <FormLabel className='font-normal'>Зафейлено</FormLabel>
                      </FormItem>
                    </RadioGroup>
                  </FormControl>
                  <FormMessage>
